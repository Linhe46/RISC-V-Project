#include <memory>
#include <verilated.h>
#include "Vcore.h"   // modified as "V<file_name>.h"
...
int main(int argc, char **argv)
{
    ...
    const std::unique_ptr<Vcore> top{new Vcore{contextp.get(), "TOP"}}; // modify the type as V<file_name>
    VerilatedVcdC *tfp = new VerilatedVcdC;
    top->trace(tfp, 0);
    tfp->open("wave_dir/core.vcd"); // set the output wave file name
