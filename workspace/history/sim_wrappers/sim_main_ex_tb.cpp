#include <memory>
#include <verilated.h>
#include "Vex_tb.h"   // modified as "V<file_name>.h"
...
std::vector<std::string> insts{
    ...
    "1111111_00010_00100_000_11111_1100011", // BEQ x4(rs1), x2(rs2), offset = -1 << 1   
...
int main(int argc, char **argv)
{
    ...
    const std::unique_ptr<Vex_tb> top{new Vex_tb{contextp.get(), "TOP"}}; // modify the type as V<file_name>
    VerilatedVcdC *tfp = new VerilatedVcdC;
    top->trace(tfp, 0);
    tfp->open("wave_dir/ex_tb.vcd"); // set the output wave file name
